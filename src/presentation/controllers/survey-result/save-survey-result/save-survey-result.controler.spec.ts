import { type LoadSurveyById, type SurveyModel, type HttpRequest, type SaveSurveyResult, type SaveSurveyResultParams, type SurveyResultModel } from './save-survey-result-controller-protocols'
